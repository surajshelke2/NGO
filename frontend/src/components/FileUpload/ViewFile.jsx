    ...
    const fetchFiles = async () => {
      try {
        const res = await axios.get(
          `http://localhost:3000/api/v1/class/subject/unit/content/file/gets/${classId}`
        );
        setFiles(res.data);
              ...
              <div key={file.id} className="bg-white shadow-md rounded-md p-4">
                ...
                <div className="mt-4">
                  <a
                    ...
                    className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline transition duration-300 ease-in-out transform hover:scale-105 mr-2"
                    target="_blank"
