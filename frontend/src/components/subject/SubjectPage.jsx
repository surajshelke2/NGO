...
export default function SubjectPage(){
    ...
    useEffect(()=>{
        ...
        ;(async()=>{
            await axios.get(`http://localhost:3000/api/v1/class/subject/${classid}`).then((res)=>{
                setLoading(false)
        ...
        subjectId && (async ()=>{
            await axios.get(`http://localhost:3000/api/v1/class/subject/unit/${subjectId}`).then((res)=>{
    ...
    async function HandleDeleteUnit(e){
        await axios.delete(`http://localhost:3000/api/v1/class/subject/unit/${subjectId}/delete/${e.target.id}`).then((res)=>{
